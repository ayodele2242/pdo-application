							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Loan Products</h5>
										<!--end::Page Title-->
							...
							<div class="container">
								<div class="row">
									<div class="col-lg-4 col-sm-12">
						                ...
						                <input type="text" name="amount"  class="form-control thousand" placeholder="">
						                </div>

						                <div class="form-group stas mb-2" >
						                  <label>Interest Rate(%)</label>  
						                <input type="text" name="interest_rate"  class="form-control" placeholder="">
						                </div>
						                ...
						                <input type="text" name="late_interest"  class="form-control" placeholder="">
						                </div>

						                 <div class="form-group mb-2">
						                    <label>Description</label>
						              <textarea class="summernote" id="editor" class="form-control" name="info"></textarea>
						                </div>
									...
									<div class="col-lg-8 col-sm-12 bg-white col-grey pt-3 pb-3">
 ...
 $('#insertPackages').click(function(event) {
  ...
  $.ajax({
    ...
    { 
        ...
        setTimeout('window.location.href = "loan_products"; ',500);
