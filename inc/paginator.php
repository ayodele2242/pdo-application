...
class Paginator {
    ...
    $this->_conn = $mysqli; //mysql connection resource
    ...
    public function createLinks( $links, $list_class ) 
    {
        ...
        //echo 'Start: '.$this->_row_start.' | '; //total rows
        ...
        '<a href="page-link"><li class="' . $class . ' page-item">&laquo;</a></li>' : //remove link from previous button
        '<li class="' . $class . ' page-item"><a class="page-link" href="?limit=' . $this->_limit . '&page=' . ( $this->_page - 1 ) . '">&laquo;</a></li>';

        $html .= $previous_page;

        if ( $start > 1 ) { //print ... before (previous <<< link)
            $html .= '<li class="page-item"><a class="page-link" href="?limit=' . $this->_limit . '&page=1">1</a></li>'; //print first page link
            $html .= '<li class="disabled page-item"><span class="page-link">...</span></li>'; //print 3 dots if not on first page
        }
        ...
        if ( $end < $last ) { //print ... before next page (>>> link)
            $html .= '<li class="disabled page-item"><span class="page-link">...</span></li>'; //print 3 dots if not on last page
            $html .= '<li class="page-item"><a class="page-link" href="?limit=' . $this->_limit . '&page=' . $last . '">' . $last . '</a></li>'; //print last page link
        }
        ...
        '<li class="' . $class . ' page-item"><a class="page-link" href="">&raquo;</a></li>' : //remove link from next button
        '<li class="' . $class . ' page-item"><a class="page-link" href="?limit=' . $this->_limit . '&page=' . ( $this->_page + 1 ) . '">&raquo;</a></li>';
